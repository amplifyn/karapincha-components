...
const KpButton = class {
    ...
    render() {
        return (core.h(core.Host, null, core.h("button", { class: this.classNames, id: this.buttonId }, core.h("slot", null))));
        // if (this.isLoading) {
        //   return (
        //     <Host>
    ...
    static get style() { return "*,:after,:before{-webkit-box-sizing:border-box;box-sizing:border-box}kp-button{display:-ms-inline-flexbox;display:inline-flex;outline:none}.kp-button{--btn-height:40px;--btn-padding-right:16px;--btn-padding-left:16px;--btn-default-text-color:#fff;--btn-default-bg-color:#00b8a7;--btn-border-color:#00b8a7;--btn-border-width:1px;--btn-border-style:solid;--btn-border-radius:24px;display:-ms-flexbox;display:flex;padding-right:var(--btn-padding-right);padding-left:var(--btn-padding-left);height:var(--btn-height);-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;color:var(--btn-default-text-color);font-size:16px;font-weight:600;letter-spacing:-.22px;background-color:var(--btn-default-bg-color);border-color:var(--btn-border-color);border-style:var(--btn-border-style);border-width:var(--btn-border-width);border-radius:var(--btn-border-radius);outline:none;cursor:pointer}"; }
};

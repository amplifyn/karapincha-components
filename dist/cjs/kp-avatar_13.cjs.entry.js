...
const KpButton = class {
    ...
    render() {
        return (core.h(core.Host, { class: this.hostClassNames }, core.h("button", { class: this.classNames, type: this.isType }, core.h("slot", null))));
        // if (this.isLoading) {
        //   return (
        //     <Host>

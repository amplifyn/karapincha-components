...
const DeckdeckgoHighlightCode = class {
    constructor(hostRef) {
        ...
        this.prismLanguageLoaded = core.createEvent(this, "prismLanguageLoaded", 7);
        this.codeDidChange = core.createEvent(this, "codeDidChange", 7);
    }
    ...
    render() {
        return (core.h(core.Host, { class: { 'deckgo-highlight-code-edit': this.editing } }, core.h("div", { class: "deckgo-highlight-code-container", onMouseDown: () => this.edit(), onTouchStart: () => this.edit() }, core.h("code", null), core.h("slot", { name: "code" }))));
    }

...
const KpColorRibbon = class {
    ...
    render() {
        return (core.h(core.Host, { class: { 'kp-color-ribbon': true, 'isCard': this.isCard } }, core.h("span", { class: { 'kp-color-ribbon__chip': true }, style: { 'background-color': this.colorHex.toUpperCase() } }), core.h("span", { class: { 'kp-color-ribbon__name': true } }, this.colorWeight, " - ", this.colorName), core.h("span", { class: { 'kp-color-ribbon__hex-value': true } }, this.colorHex.toUpperCase()), core.h("span", { class: { 'kp-color-ribbon__rgb-value': true } }, this.colorRgb)));
    }
...
exports.kp_color_palette = KpColorPalette;

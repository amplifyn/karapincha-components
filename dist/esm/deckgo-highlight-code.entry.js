import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './core-07d50397.js';
...
const DeckdeckgoHighlightCode = class {
    ...
    render() {
        return (h(Host, { class: { 'deckgo-highlight-code-edit': this.editing } }, h("div", { class: "deckgo-highlight-code-container", onMouseDown: () => this.edit(), onTouchStart: () => this.edit() }, h("code", null), h("slot", { name: "code" }))));
    }

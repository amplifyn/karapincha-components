...
var KpAvatar = /** @class */ (function () {
    ...
    KpAvatar.prototype.render = function () {
        if (this.isDefault) {
...
var KpButton = /** @class */ (function () {
    ...
    Object.defineProperty(KpButton, "style", {
        get: function () { return "*,:after,:before{-webkit-box-sizing:border-box;box-sizing:border-box}.kp-button,kp-button{display:-ms-inline-flexbox;display:inline-flex;outline:none}.kp-button{--btn-height:40px;--btn-padding-right:16px;--btn-padding-left:16px;--btn-default-text-color:#fff;--btn-default-bg-color:#00b8a7;--btn-border-color:#00b8a7;--btn-border-width:1px;--btn-border-style:solid;--btn-border-radius:24px;padding-right:var(--btn-padding-right);padding-left:var(--btn-padding-left);height:var(--btn-height);color:var(--btn-default-text-color);font-size:16px;font-weight:600;letter-spacing:-.22px;background-color:var(--btn-default-bg-color);border-color:var(--btn-border-color);border-style:var(--btn-border-style);border-width:var(--btn-border-width);border-radius:var(--btn-border-radius);cursor:pointer}"; },
        enumerable: true,
        configurable: true
    });
    return KpButton;
...
var KpFab = /** @class */ (function () {
    function KpFab(hostRef) {
        registerInstance(this, hostRef);
        this.isDisabled = false;
        this.isLoading = false;
        //Button class names
    ...
    KpFab.prototype.iconClassGenerate = function (dataIconName) {
        if (dataIconName != null && dataIconName != undefined && dataIconName != '') {
            var iconClassName = dataIconName;
            return 'kp-fab__icon kp-fab__icon--' + iconClassName;
        }
    };
    // Remove white spaces from string
    KpFab.prototype.removeWhiteSpacesClass = function (string) {
        return string.replace(/\s/g, "");
    };
    KpFab.prototype.render = function () {
        if (this.isLoading) {
...
var KpLabel = /** @class */ (function () {
    function KpLabel(hostRef) {
        registerInstance(this, hostRef);
        // State props
        this.isError = false;
    }
    KpLabel.prototype.render = function () {
...
var KpLogo = /** @class */ (function () {
    ...
    KpLogo.prototype.render = function () {
        if (this.isDefault) {
    ...
    Object.defineProperty(KpLogo.prototype, "hostElement", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(KpLogo, "style", {
        get: function () { return ".kp-logo{--kp-logo-width:6.25rem;--kp-logo-height:auto}.kp-logo svg{width:var(--kp-logo-width);height:var(--kp-logo-height)}.kp-logo--small{--kp-logo-small-width:1.5rem}.kp-logo--small,.kp-logo--small svg{width:var(--kp-logo-small-width)}.kp-logo--large{--kp-logo-large-width:2.8125rem}.kp-logo--large,.kp-logo--large svg{width:var(--kp-logo-large-width)}"; },
        enumerable: true,
        configurable: true
    });
    return KpLogo;
}());
var KpSpiner = /** @class */ (function () {
    function KpSpiner(hostRef) {
        registerInstance(this, hostRef);
    }
    KpSpiner.prototype.render = function () {

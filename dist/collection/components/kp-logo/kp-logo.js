...
export class KpLogo {
    ...
    render() {
        if (this.isDefault) {
            ...
            return (h(Host, null,
                h("img", { src: this.imageSrc, alt: this.imageAlt, class: this.classNames })));
        }
        else {
